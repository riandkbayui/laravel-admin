...
return [
    ...
    'userNotFound'              => 'Tidak dapat menemukan pengguna dengan ID = {0}.',
    ...
    'passwordNotMatch'          => 'Kata sandi tidak sesuai.',
    ...
    'userExist' => 'Pengguna sudah terdaftar',
    ...
    'activationMailSent'    => 'Link aktivasi telah dikirim ke email anda. Silakan buka link tersebut untuk melanjutkan',
    'activationSuccess'         => 'Aktivasi akun berhasil, silakan login dengan kredensial Anda.',
    ...
    'forgotEmailSent'           => 'Token keamanan telah dikirim ke email Anda. Klik tautan didalam email untuk melanjutkan.',
    ...
    // Mail
    'activationMailSubject' => 'Activate Account',
    'resetPasswordMailSubject' => 'Reset Password',
    'pin_code' => "Pin transaksi tidak sesuai, silahkan atur pada halaman profil.",
